...
def what_recipes(lunch_list, dinner_list):
    ...
    for e in dinner_list:
        ...
        if e[0]==1:
            ...
            index=list(veggie_db['id']).index(r2_score)
            set_aldi.append(veggie_db['ings'][index])
    ...
    show_recipes(lunch_recipes, dinner_recipes, total)
...
def show_recipes(lunch_recipes, dinner_recipes, total):
            ...
            if event.type == pygame.MOUSEBUTTONUP:
                ...
                if 175<y<325:
                    ...
                    for i in range(5):
                        ...
                        if px<x<px+150:
                            n=i
                            get_recipe(lunch_recipes, dinner_recipes, s, n, total)
                            b=False
...
def get_recipe(lunch_recipes, dinner_recipes, s, n, total):
